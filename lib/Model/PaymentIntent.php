...
class PaymentIntent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setCsc($csc)
    {
        ...
        if ((mb_strlen($csc) > 4)) {
            throw new \InvalidArgumentException('invalid length for $csc when calling PaymentIntent., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($csc) < 3)) {
            throw new \InvalidArgumentException('invalid length for $csc when calling PaymentIntent., must be bigger than or equal to 3.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentIntent., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling PaymentIntent., must be bigger than or equal to 3.');
        }
    ...
    public function setIdentifier($identifier)
    {
        ...
        if ((mb_strlen($identifier) > 50)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling PaymentIntent., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($identifier) < 4)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling PaymentIntent., must be bigger than or equal to 4.');
        }
    ...
    public function setTransInfo($trans_info)
    {
        ...
        if ((mb_strlen($trans_info) > 50)) {
            throw new \InvalidArgumentException('invalid length for $trans_info when calling PaymentIntent., must be smaller than or equal to 50.');
        }
    ...
    public function setTransType($trans_type)
    {
        ...
        if ((mb_strlen($trans_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $trans_type when calling PaymentIntent., must be smaller than or equal to 1.');
        }
