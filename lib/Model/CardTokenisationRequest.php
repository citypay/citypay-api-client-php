...
/**
 * CardTokenisationRequest Class Doc Comment
 *
 * @category Class
 * @package  CityPay
 * @author   OpenAPI Generator team
 ...
 */
class CardTokenisationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CardTokenisationRequest';
    ...
    public function setCardnumber($cardnumber)
    {
        ...
        if ((mb_strlen($cardnumber) > 22)) {
            throw new \InvalidArgumentException('invalid length for $cardnumber when calling CardTokenisationRequest., must be smaller than or equal to 22.');
        }
        if ((mb_strlen($cardnumber) < 12)) {
            throw new \InvalidArgumentException('invalid length for $cardnumber when calling CardTokenisationRequest., must be bigger than or equal to 12.');
        }
    ...
    public function setCsc($csc)
    {
        ...
        if ((mb_strlen($csc) > 4)) {
            throw new \InvalidArgumentException('invalid length for $csc when calling CardTokenisationRequest., must be smaller than or equal to 4.');
        }
        if ((mb_strlen($csc) < 3)) {
            throw new \InvalidArgumentException('invalid length for $csc when calling CardTokenisationRequest., must be bigger than or equal to 3.');
        }
    ...
    public function setExpmonth($expmonth)
    {
        ...
        if (($expmonth > 12)) {
            throw new \InvalidArgumentException('invalid value for $expmonth when calling CardTokenisationRequest., must be smaller than or equal to 12.');
        }
        if (($expmonth < 1)) {
            throw new \InvalidArgumentException('invalid value for $expmonth when calling CardTokenisationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setExpyear($expyear)
    {
        ...
        if (($expyear > 2100)) {
            throw new \InvalidArgumentException('invalid value for $expyear when calling CardTokenisationRequest., must be smaller than or equal to 2100.');
        }
        if (($expyear < 2000)) {
            throw new \InvalidArgumentException('invalid value for $expyear when calling CardTokenisationRequest., must be bigger than or equal to 2000.');
        }
    ...
    public function setNameOnCard($name_on_card)
    {
        ...
        if ((mb_strlen($name_on_card) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name_on_card when calling CardTokenisationRequest., must be smaller than or equal to 45.');
        }
        if ((mb_strlen($name_on_card) < 2)) {
            throw new \InvalidArgumentException('invalid length for $name_on_card when calling CardTokenisationRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setUuid($uuid)
    {
        ...
        if ((mb_strlen($uuid) > 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling CardTokenisationRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($uuid) < 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling CardTokenisationRequest., must be bigger than or equal to 36.');
        }
