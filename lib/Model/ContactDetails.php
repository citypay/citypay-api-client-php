...
class ContactDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets address1
     *
     * @param string|null $address1 The first line of the address for the shipping contact.
     *
     * @return self
     */
     ...
     * Sets address2
     *
     * @param string|null $address2 The second line of the address for the shipping contact.
     *
     * @return self
     */
     ...
     * Sets address3
     *
     * @param string|null $address3 The third line of the address for the shipping contact.
     *
     * @return self
     */
     ...
     * Sets area
     *
     * @param string|null $area The area such as city, department, parish for the shipping contact.
     *
     * @return self
     */
     ...
     * Sets company
     *
     * @param string|null $company The company name for the shipping contact if the contact is a corporate contact.
     *
     * @return self
     */
     ...
     * Sets email
     *
     * @param string|null $email An email address for the shipping contact which may be used for correspondence.
     *
     * @return self
     */
     ...
     * Sets firstname
     *
     * @param string|null $firstname The first name  of the shipping contact.
     *
     * @return self
     */
     ...
     * Sets lastname
     *
     * @param string|null $lastname The last name or surname of the shipping contact.
     *
     * @return self
     */
     ...
     * Sets mobile_no
     *
     * @param string|null $mobile_no A mobile number for the shipping contact the mobile number is often required by delivery companies to ensure they are able to be in contact when required.
     *
     * @return self
     */
     ...
     * Sets telephone_no
     *
     * @param string|null $telephone_no A telephone number for the shipping contact.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title A title for the shipping contact such as Mr, Mrs, Ms, M. Mme. etc.
     *
     * @return self
     */
