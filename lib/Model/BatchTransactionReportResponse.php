...
/**
 * BatchTransactionReportResponse Class Doc Comment
 *
 * @category Class
 * @package  CityPay
 * @author   OpenAPI Generator team
 ...
 */
class BatchTransactionReportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BatchTransactionReportResponse';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'data' => '\CityPay\Model\AuthReference[]',
        'max_results' => 'int',
        'next_token' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \CityPay\Model\AuthReference[] $data data
     *
     * @return self
     */
