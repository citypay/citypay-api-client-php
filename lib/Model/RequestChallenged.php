...
class RequestChallenged implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('creq', $data ?? [], null);
        $this->setIfExists('merchantid', $data ?? [], null);
        $this->setIfExists('threedserver_trans_id', $data ?? [], null);
    ...
    {
        if (is_null($creq)) {
            throw new \InvalidArgumentException('non-nullable creq cannot be null');
        }
    ...
    {
        if (is_null($threedserver_trans_id)) {
            throw new \InvalidArgumentException('non-nullable threedserver_trans_id cannot be null');
        }
