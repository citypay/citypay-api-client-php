...
class DirectPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setUuid($uuid)
    {
        ...
        if ((mb_strlen($uuid) > 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling DirectPostRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($uuid) < 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling DirectPostRequest., must be bigger than or equal to 36.');
        }
