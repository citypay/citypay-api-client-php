...
class AuthResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets cavv
     *
     * @param string|null $cavv The cardholder authentication verification value which can be returned for verification purposes of the authenticated  transaction for dispute realisation. The value is considered sensitive in the realm of PCI-3DS and is masked.
     *
     * @return self
     */
     ...
     * Sets external_ref
     *
     * @param string|null $external_ref An external ref if supplied.
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_ref_source An external ref source if supplied.
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_intent_id A payment intent id for the authorisation if it exists.
     *
     * @return self
     */
     ...
     * Sets trans_type
     *
     * @param string|null $trans_type The type of transaction.
     *
     * @return self
     */
