...
/**
 * ChallengeModel Class Doc Comment
 *
 * @category Class
 * @package  CityPay
 * @author   OpenAPI Generator team
 ...
 */
class ChallengeModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ChallengeModel';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['authentication_result'] === null) {
            $invalidProperties[] = "'authentication_result' can't be null";
        }
     ...
     * Sets acs_url
     *
     * @param string|null $acs_url A url to connect to for authentication.
     *
     * @return self
     */
     ...
     *
     * @param string $authentication_result The result of authentication.
     *
     * @return self
     */
     ...
     *
     * @param string|null $challenge_window_size A string representing the desired challenge window size. Acceptable values are: '01' - Dimensions: 250px width by 400px height. '02' - Dimensions: 390px width by 400px height. '03' - Dimensions: 500px width by 600px height. '04' - Dimensions: 600px width by 400px height. '05' - Fullscreen window (100% width and height). Any other value defaults to '03', returning dimensions of 500px by 600px.
     *
     * @return self
     */
     ...
     * Sets creq
     *
     * @param string|null $creq A challenge request packet to submit to the ACS URL.
     *
     * @return self
     */
     ...
     *
     * @param string $three_ds_server_trans_id The 3DSS transaction id.
     *
     * @return self
     */
