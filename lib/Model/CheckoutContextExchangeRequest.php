...
/**
 * CheckoutContextExchangeRequest Class Doc Comment
 *
 * @category Class
 * @package  CityPay
 * @author   OpenAPI Generator team
 ...
 */
class CheckoutContextExchangeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CheckoutContextExchangeRequest';
     ...
     *
     * @param string $checkout_context_id The opaque checkout context identifier returned by context create.
     *
     * @return self
     */
    public function setCheckoutContextId($checkout_context_id)
    {
        ...
        if ((mb_strlen($checkout_context_id) > 64)) {
            throw new \InvalidArgumentException('invalid length for $checkout_context_id when calling CheckoutContextExchangeRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($checkout_context_id) < 3)) {
            throw new \InvalidArgumentException('invalid length for $checkout_context_id when calling CheckoutContextExchangeRequest., must be bigger than or equal to 3.');
        }
     ...
     * Sets session_token
     *
     * @param string $session_token The signed checkout context token returned by context create.
     *
     * @return self
     */
     ...
     * Sets opaque_key
     *
     * @param string $opaque_key The opaque checkout context key returned by context create.
     *
     * @return self
     */
    ...
    public function setAccountId($account_id)
    {
        ...
        if ((mb_strlen($account_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling CheckoutContextExchangeRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($account_id) < 5)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling CheckoutContextExchangeRequest., must be bigger than or equal to 5.');
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if ((mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CheckoutContextExchangeRequest., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CheckoutContextExchangeRequest., must be bigger than or equal to 3.');
        }
    ...
    public function setExternalRef($external_ref)
    {
        ...
        if ((mb_strlen($external_ref) > 256)) {
            throw new \InvalidArgumentException('invalid length for $external_ref when calling CheckoutContextExchangeRequest., must be smaller than or equal to 256.');
        }
    ...
    public function setIdentifier($identifier)
    {
        ...
        if ((mb_strlen($identifier) > 50)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling CheckoutContextExchangeRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($identifier) < 4)) {
            throw new \InvalidArgumentException('invalid length for $identifier when calling CheckoutContextExchangeRequest., must be bigger than or equal to 4.');
        }
    ...
    public function setTransInfo($trans_info)
    {
        ...
        if ((mb_strlen($trans_info) > 50)) {
            throw new \InvalidArgumentException('invalid length for $trans_info when calling CheckoutContextExchangeRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setTransType($trans_type)
    {
        ...
        if ((mb_strlen($trans_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $trans_type when calling CheckoutContextExchangeRequest., must be smaller than or equal to 1.');
        }
