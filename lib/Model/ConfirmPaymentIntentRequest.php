...
class ConfirmPaymentIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $payment_intent_id The id of the payment intent to confirm.
     *
     * @return self
     */
    ...
    public function setUuid($uuid)
    {
        ...
        if ((mb_strlen($uuid) > 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling ConfirmPaymentIntentRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($uuid) < 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling ConfirmPaymentIntentRequest., must be bigger than or equal to 36.');
        }
