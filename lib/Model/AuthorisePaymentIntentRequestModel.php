...
/**
 * AuthorisePaymentIntentRequestModel Class Doc Comment
 *
 * @category Class
 * @package  CityPay
 * @author   OpenAPI Generator team
 ...
 */
class AuthorisePaymentIntentRequestModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuthorisePaymentIntentRequestModel';
     ...
     *
     * @param string|null $payment_intent_id The id of the payment intent to authorise.
     *
     * @return self
     */
     ...
     * Sets verify
     *
     * @param bool|null $verify Indicates whether the authorisation is for card verification only. When true, the transaction is performed as a verification check and not as a payment.
     *
     * @return self
     */
