...
/**
 * RemittanceReportResponse Class Doc Comment
 *
 * @category Class
 * @package  CityPay
 * @author   OpenAPI Generator team
 ...
 */
class RemittanceReportResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RemittanceReportResponse';
    ...
    protected static $openAPITypes = [
        'count' => 'int',
        'data' => '\CityPay\Model\RemittedClientData[]',
        'max_results' => 'int',
        'next_token' => 'string'
    ];
     ...
     * Sets data
     *
     * @param \CityPay\Model\RemittedClientData[] $data data
     *
     * @return self
     */
