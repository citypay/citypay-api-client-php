 ...
 */
class AuthnModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AuthnModel';
    ...
    {
        $this->setIfExists('ds_version', $data ?? [], null);
     ...
     * @return string|null
     */
    public function getDsVersion()
    {
        return $this->container['ds_version'];
    }

    /**
     * Sets ds_version
     *
     * @param string|null $ds_version 3DS version used, e.g. '2.2.0'.
     *
     * @return self
     */
    public function setDsVersion($ds_version)
    {
        if (is_null($ds_version)) {
            throw new \InvalidArgumentException('non-nullable ds_version cannot be null');
        }
        $this->container['ds_version'] = $ds_version;
     ...
     * Sets result
     *
     * @param string $result Normalised result `authenticated` | `attempted` | `unavailable`.
     *
     * @return self
     */
     ...
     * Sets trans_status
     *
     * @param string $trans_status 3DS ARes transStatus (Y, A, U). 'Y' = authenticated, 'A' = attempted, 'U' = unavailable.
     *
     * @return self
     */
