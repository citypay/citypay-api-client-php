...
class PaylinkTokenStatusChangeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets order_by
     *
     * @param string|null $order_by Specifies the field by which results are ordered. Available fields are [p.id]. By default, fields are ordered by OrderByExpression(p.id,ASC). To order in descending order, prefix with '-' or suffix with ' DESC'.
     *
     * @return self
     */
