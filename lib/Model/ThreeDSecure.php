...
class ThreeDSecure implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets browser_tz
     *
     * @param string|null $browser_tz BrowserTZ field used for 3DSv2 browser enablement. Recommendation is to use citypay.js and the `bx` function to gather this value.
     *
     * @return self
     */
