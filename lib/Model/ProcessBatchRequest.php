...
class ProcessBatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets account_id
     *
     * @param string|null $account_id The batch account id to process the batch for. Defaults to your client id if not provided.
     *
     * @return self
     */
    public function setAccountId($account_id)
    {
        if (!is_null($account_id) && (mb_strlen($account_id) > 20)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling ProcessBatchRequest., must be smaller than or equal to 20.');
        }
        if (!is_null($account_id) && (mb_strlen($account_id) < 3)) {
            throw new \InvalidArgumentException('invalid length for $account_id when calling ProcessBatchRequest., must be bigger than or equal to 3.');
        }
