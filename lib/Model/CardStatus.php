 ...
 */
class CardStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CardStatus';
     ...
     * Sets card_status
     *
     * @param string|null $card_status The status of the card to set, valid values are ACTIVE or INACTIVE.
     *
     * @return self
     */
     ...
     * Sets default
     *
     * @param bool|null $default Defines if the card is set as the default.
     *
     * @return self
     */
