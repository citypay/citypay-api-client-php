...
class Decision implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'authen_required' => false,
        'auth_response' => false,
        'request_challenged' => false
    ];
    ...
    {
        $this->setIfExists('authen_required', $data ?? [], null);
        $this->setIfExists('auth_response', $data ?? [], null);
        $this->setIfExists('request_challenged', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($authen_required)) {
            throw new \InvalidArgumentException('non-nullable authen_required cannot be null');
        }
    ...
    public function setAuthResponse($auth_response)
    {
        if (is_null($auth_response)) {
            throw new \InvalidArgumentException('non-nullable auth_response cannot be null');
        }
    ...
    {
        if (is_null($request_challenged)) {
            throw new \InvalidArgumentException('non-nullable request_challenged cannot be null');
        }
