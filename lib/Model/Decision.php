...
class Decision implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['authen_required'] = $data['authen_required'] ?? null;
        $this->container['auth_response'] = $data['auth_response'] ?? null;
        $this->container['request_challenged'] = $data['request_challenged'] ?? null;
    }
