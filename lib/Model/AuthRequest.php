...
class AuthRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCardholderAgreement($cardholder_agreement)
    {
        ...
        if ((mb_strlen($cardholder_agreement) > 1)) {
            throw new \InvalidArgumentException('invalid length for $cardholder_agreement when calling AuthRequest., must be smaller than or equal to 1.');
        }
    ...
    public function setInitiation($initiation)
    {
        ...
        if ((mb_strlen($initiation) > 1)) {
            throw new \InvalidArgumentException('invalid length for $initiation when calling AuthRequest., must be smaller than or equal to 1.');
        }
    ...
    public function setUuid($uuid)
    {
        ...
        if ((mb_strlen($uuid) > 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling AuthRequest., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($uuid) < 36)) {
            throw new \InvalidArgumentException('invalid length for $uuid when calling AuthRequest., must be bigger than or equal to 36.');
        }
