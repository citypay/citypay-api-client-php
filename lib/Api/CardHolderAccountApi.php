...
class CardHolderAccountApi
{
     ...
     * @param  bool|null $force Requests that the item is forced immediately. (optional)
     ...
     */
    public function accountCardDeleteRequest($accountid, $card_id, $force = null, string $contentType = self::contentTypes['accountCardDeleteRequest'][0])
    {
        list($response) = $this->accountCardDeleteRequestWithHttpInfo($accountid, $card_id, $force, $contentType);
        return $response;
    }
     ...
     */
    public function accountCardDeleteRequestWithHttpInfo($accountid, $card_id, $force = null, string $contentType = self::contentTypes['accountCardDeleteRequest'][0])
    {
        $request = $this->accountCardDeleteRequestRequest($accountid, $card_id, $force, $contentType);
     ...
     */
    public function accountCardDeleteRequestAsync($accountid, $card_id, $force = null, string $contentType = self::contentTypes['accountCardDeleteRequest'][0])
    {
        return $this->accountCardDeleteRequestAsyncWithHttpInfo($accountid, $card_id, $force, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountCardDeleteRequestAsyncWithHttpInfo($accountid, $card_id, $force = null, string $contentType = self::contentTypes['accountCardDeleteRequest'][0])
    {
     ...
     */
    public function accountCardDeleteRequestRequest($accountid, $card_id, $force = null, string $contentType = self::contentTypes['accountCardDeleteRequest'][0])
    {
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\CardHolderAccount
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\CardHolderAccount, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\Exists, HTTP status code, HTTP response headers (array of strings)
     */
