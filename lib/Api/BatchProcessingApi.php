...
class BatchProcessingApi
{
     ...
     */
    public function batchReportRequest($batch_report_request)
    {
        list($response) = $this->batchReportRequestWithHttpInfo($batch_report_request);
        return $response;
    }

    /**
     * Operation batchReportRequestWithHttpInfo
     *
     * BatchReportRequest
     *
     ...
     */
    public function batchReportRequestWithHttpInfo($batch_report_request)
    {
        $request = $this->batchReportRequestRequest($batch_report_request);
    ...
    /**
     * Operation batchReportRequestAsync
     *
     * BatchReportRequest
     *
     * @param  \CityPay\Model\BatchReportRequest $batch_report_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchReportRequestAsync($batch_report_request)
    {
        return $this->batchReportRequestAsyncWithHttpInfo($batch_report_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation batchReportRequestAsyncWithHttpInfo
     *
     * BatchReportRequest
     *
     * @param  \CityPay\Model\BatchReportRequest $batch_report_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function batchReportRequestAsyncWithHttpInfo($batch_report_request)
    {
        $returnType = '\CityPay\Model\BatchReportResponseModel';
        $request = $this->batchReportRequestRequest($batch_report_request);
    ...
    /**
     * Create request for operation 'batchReportRequest'
     *
     * @param  \CityPay\Model\BatchReportRequest $batch_report_request (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function batchReportRequestRequest($batch_report_request)
    {
        ...
        if ($batch_report_request === null || (is_array($batch_report_request) && count($batch_report_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $batch_report_request when calling batchReportRequest'
            );
        }
