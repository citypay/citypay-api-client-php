...
class BatchProcessingApi
{
     ...
     * @return \CityPay\Model\ProcessBatchResponse
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\ProcessBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\BatchReportResponseModel
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\BatchReportResponseModel, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\CheckBatchStatusResponse
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\CheckBatchStatusResponse, HTTP status code, HTTP response headers (array of strings)
     */
