...
class PaylinkApi
{
    ...
    /**
     * Operation paylinkTokenCloseRequest
     *
     * Close Paylink Token
     *
     * @param  string $token The token returned by the create token process. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['paylinkTokenCloseRequest'] to see the possible values for this operation
     *
     ...
     */
    public function paylinkTokenCloseRequest($token, string $contentType = self::contentTypes['paylinkTokenCloseRequest'][0])
    {
        list($response) = $this->paylinkTokenCloseRequestWithHttpInfo($token, $contentType);
        return $response;
    }

    /**
     * Operation paylinkTokenCloseRequestWithHttpInfo
     *
     * Close Paylink Token
     *
     * @param  string $token The token returned by the create token process. (required)
     ...
     */
    public function paylinkTokenCloseRequestWithHttpInfo($token, string $contentType = self::contentTypes['paylinkTokenCloseRequest'][0])
    {
        $request = $this->paylinkTokenCloseRequestRequest($token, $contentType);
    ...
    /**
     * Operation paylinkTokenCloseRequestAsync
     *
     * Close Paylink Token
     *
     * @param  string $token The token returned by the create token process. (required)
     ...
     */
    public function paylinkTokenCloseRequestAsync($token, string $contentType = self::contentTypes['paylinkTokenCloseRequest'][0])
    {
        return $this->paylinkTokenCloseRequestAsyncWithHttpInfo($token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation paylinkTokenCloseRequestAsyncWithHttpInfo
     *
     * Close Paylink Token
     *
     * @param  string $token The token returned by the create token process. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function paylinkTokenCloseRequestAsyncWithHttpInfo($token, string $contentType = self::contentTypes['paylinkTokenCloseRequest'][0])
    {
    ...
    /**
     * Create request for operation 'paylinkTokenCloseRequest'
     *
     * @param  string $token The token returned by the create token process. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['paylinkTokenCloseRequest'] to see the possible values for this operation
     *
     ...
     */
    public function paylinkTokenCloseRequestRequest($token, string $contentType = self::contentTypes['paylinkTokenCloseRequest'][0])
    {

        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling paylinkTokenCloseRequest'
            );
        }
    ...
    /**
     * Operation tokenAttachmentStatus
     *
     * Checks an attachment status
     *
     * @param  string $token The token returned by the create token process. (required)
     * @param  string $attachment The attachemnt name requested. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['tokenAttachmentStatus'] to see the possible values for this operation
     *
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\Acknowledgement
     */
    public function tokenAttachmentStatus($token, $attachment, string $contentType = self::contentTypes['tokenAttachmentStatus'][0])
    {
        list($response) = $this->tokenAttachmentStatusWithHttpInfo($token, $attachment, $contentType);
        return $response;
    }

    /**
     * Operation tokenAttachmentStatusWithHttpInfo
     *
     * Checks an attachment status
     *
     * @param  string $token The token returned by the create token process. (required)
     ...
     * @return array of \CityPay\Model\Acknowledgement, HTTP status code, HTTP response headers (array of strings)
     */
    public function tokenAttachmentStatusWithHttpInfo($token, $attachment, string $contentType = self::contentTypes['tokenAttachmentStatus'][0])
    {
        $request = $this->tokenAttachmentStatusRequest($token, $attachment, $contentType);
    ...
    /**
     * Operation tokenAttachmentStatusAsync
     *
     * Checks an attachment status
     *
     * @param  string $token The token returned by the create token process. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tokenAttachmentStatusAsync($token, $attachment, string $contentType = self::contentTypes['tokenAttachmentStatus'][0])
    {
        return $this->tokenAttachmentStatusAsyncWithHttpInfo($token, $attachment, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation tokenAttachmentStatusAsyncWithHttpInfo
     *
     * Checks an attachment status
     *
     * @param  string $token The token returned by the create token process. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function tokenAttachmentStatusAsyncWithHttpInfo($token, $attachment, string $contentType = self::contentTypes['tokenAttachmentStatus'][0])
    {
        $returnType = '\CityPay\Model\Acknowledgement';
        $request = $this->tokenAttachmentStatusRequest($token, $attachment, $contentType);
    ...
    /**
     * Create request for operation 'tokenAttachmentStatus'
     *
     * @param  string $token The token returned by the create token process. (required)
     * @param  string $attachment The attachemnt name requested. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['tokenAttachmentStatus'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function tokenAttachmentStatusRequest($token, $attachment, string $contentType = self::contentTypes['tokenAttachmentStatus'][0])
    {

        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling tokenAttachmentStatus'
            );
        }
        ...
        if ($attachment === null || (is_array($attachment) && count($attachment) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $attachment when calling tokenAttachmentStatus'
            );
        }


        $resourcePath = '/paylink/{token}/attachment-status/{attachment}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\PaylinkTokenStatusChangeResponse
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\PaylinkTokenStatusChangeResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\PaylinkTokenCreated
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\PaylinkTokenCreated, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\PaylinkTokenStatus
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\PaylinkTokenStatus, HTTP status code, HTTP response headers (array of strings)
     */
