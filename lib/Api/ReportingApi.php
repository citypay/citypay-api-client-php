...
class ReportingApi
{
     ...
     * @return \CityPay\Model\BatchTransactionReportResponse
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\BatchTransactionReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\MerchantBatchReportResponse
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\MerchantBatchReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\MerchantBatchResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\RemittanceReportResponse
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\RemittanceReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\RemittedClientData
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\RemittedClientData, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation transactionReportRequest
     *
     * Transaction Report Request
     *
     * @param  \CityPay\Model\TransactionReportRequest $transaction_report_request transaction_report_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transactionReportRequest'] to see the possible values for this operation
     *
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\BatchTransactionReportResponse
     */
    public function transactionReportRequest($transaction_report_request, string $contentType = self::contentTypes['transactionReportRequest'][0])
    {
        list($response) = $this->transactionReportRequestWithHttpInfo($transaction_report_request, $contentType);
        return $response;
    }

    /**
     * Operation transactionReportRequestWithHttpInfo
     *
     * Transaction Report Request
     *
     * @param  \CityPay\Model\TransactionReportRequest $transaction_report_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transactionReportRequest'] to see the possible values for this operation
     *
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\BatchTransactionReportResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function transactionReportRequestWithHttpInfo($transaction_report_request, string $contentType = self::contentTypes['transactionReportRequest'][0])
    {
        $request = $this->transactionReportRequestRequest($transaction_report_request, $contentType);
    ...
    /**
     * Operation transactionReportRequestAsync
     *
     * Transaction Report Request
     *
     * @param  \CityPay\Model\TransactionReportRequest $transaction_report_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transactionReportRequestAsync($transaction_report_request, string $contentType = self::contentTypes['transactionReportRequest'][0])
    {
        return $this->transactionReportRequestAsyncWithHttpInfo($transaction_report_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation transactionReportRequestAsyncWithHttpInfo
     *
     * Transaction Report Request
     *
     * @param  \CityPay\Model\TransactionReportRequest $transaction_report_request (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transactionReportRequestAsyncWithHttpInfo($transaction_report_request, string $contentType = self::contentTypes['transactionReportRequest'][0])
    {
        $returnType = '\CityPay\Model\BatchTransactionReportResponse';
        $request = $this->transactionReportRequestRequest($transaction_report_request, $contentType);
    ...
    /**
     * Create request for operation 'transactionReportRequest'
     *
     * @param  \CityPay\Model\TransactionReportRequest $transaction_report_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transactionReportRequest'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function transactionReportRequestRequest($transaction_report_request, string $contentType = self::contentTypes['transactionReportRequest'][0])
    {

        // verify the required parameter 'transaction_report_request' is set
        if ($transaction_report_request === null || (is_array($transaction_report_request) && count($transaction_report_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $transaction_report_request when calling transactionReportRequest'
            );
        }


        $resourcePath = '/v6/transactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($transaction_report_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($transaction_report_request));
            } else {
                $httpBody = $transaction_report_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
