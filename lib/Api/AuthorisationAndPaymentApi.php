...
class AuthorisationAndPaymentApi
{
     ...
     */
    public function authorisationRequestRequest($auth_request)
    {
        ...
        if (isset($auth_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($auth_request));
            } else {
    ...
    {
        list($response) = $this->binRangeLookupRequestWithHttpInfo($bin_lookup);
        return $response;
    }
    ...
    {
        $request = $this->binRangeLookupRequestRequest($bin_lookup);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function binRangeLookupRequestAsync($bin_lookup)
    {
        return $this->binRangeLookupRequestAsyncWithHttpInfo($bin_lookup)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function binRangeLookupRequestAsyncWithHttpInfo($bin_lookup)
    {
        $returnType = '\CityPay\Model\Bin';
        $request = $this->binRangeLookupRequestRequest($bin_lookup);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function binRangeLookupRequestRequest($bin_lookup)
    {
        ...
        if (isset($bin_lookup)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($bin_lookup));
            } else {
                $httpBody = $bin_lookup;
            }
        } elseif (count($formParams) > 0) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function cResRequestRequest($c_res_auth_request)
    {
        ...
        if (isset($c_res_auth_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($c_res_auth_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function captureRequestRequest($capture_request)
    {
        ...
        if (isset($capture_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($capture_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function paResRequestRequest($pa_res_auth_request)
    {
        ...
        if (isset($pa_res_auth_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($pa_res_auth_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function refundRequestRequest($refund_request)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function retrievalRequestRequest($retrieve_request)
    {
        ...
        if (isset($retrieve_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($retrieve_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function voidRequestRequest($void_request)
    {
        ...
        if (isset($void_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($void_request));
            } else {
