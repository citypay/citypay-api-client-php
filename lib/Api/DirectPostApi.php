...
class DirectPostApi
{
     ...
     * @param  string|null $cres The CRES from the ACS. (optional)
     * @param  string|null $three_ds_session_data The session data from the ACS. (optional)
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \CityPay\Model\TokenisationResponseModel
     */
     ...
     * @throws \CityPay\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \CityPay\Model\TokenisationResponseModel, HTTP status code, HTTP response headers (array of strings)
     */
