...
class ApiKeyTest extends TestCase
{
    ...
    public function testGeneration()
    {
        ...
        self::assertEquals("UEMyOkFDQjg3NUFFRjA4M0RFMjkyMjk5QkQ2OUZDREVCNUM1Ol6Q3tCMPsYvqNhFelRD2zQHYlZquBGCY/6ZpZ0AngTF", $key);
        ...
        $data = [
            ...
            ["ANWG7Vm0M","nCg3HeqhaDps6TZW","D3CF885E78D029AFFF6556B671EA5218","2020-01-09T04:02:00","QU5XRzdWbTBNOkQzQ0Y4ODVFNzhEMDI5QUZGRjY1NTZCNjcxRUE1MjE4OsBwvBUChvSNpwfUDhiojDldWGSi/X4/TyEIlWH7sf4m"],
        ...
        for ($i = 0; $i < count($data); $i++) {
            $apiKey = new ApiKey($data[$i][0], $data[$i][1]);
            $key = $apiKey->generateWith((string)$data[$i][2], \DateTime::createFromFormat("Y-m-d\TH:i:s", (string)$data[$i][3]));
            self::assertEquals($data[$i][4], $key);
            $c++;
        }

        self::assertEquals(count($data), $c);
