...
Generated from CityPay API version 6.13.32.
...
------------ | ------------- | ------------- | -------------
*AuthorisationAndPaymentApi* | [**applePayAvailabilityRequest**](docs/Api/AuthorisationAndPaymentApi.md#applepayavailabilityrequest) | **GET** /v6/apple-pay/availability | Apple Pay Availability
*AuthorisationAndPaymentApi* | [**applePayDomainDeleteRequest**](docs/Api/AuthorisationAndPaymentApi.md#applepaydomaindeleterequest) | **DELETE** /v6/apple-pay/domains/{domainId} | Disable Apple Pay Domain
*AuthorisationAndPaymentApi* | [**applePayDomainsCreateRequest**](docs/Api/AuthorisationAndPaymentApi.md#applepaydomainscreaterequest) | **POST** /v6/apple-pay/domains | Add Apple Pay Domains
*AuthorisationAndPaymentApi* | [**applePayDomainsListRequest**](docs/Api/AuthorisationAndPaymentApi.md#applepaydomainslistrequest) | **GET** /v6/apple-pay/domains | List Apple Pay Domains
*AuthorisationAndPaymentApi* | [**applePayDomainsVerifyRequest**](docs/Api/AuthorisationAndPaymentApi.md#applepaydomainsverifyrequest) | **POST** /v6/apple-pay/domains/verify | Verify Apple Pay Domains
*AuthorisationAndPaymentApi* | [**applePayOnboardApiRequest**](docs/Api/AuthorisationAndPaymentApi.md#applepayonboardapirequest) | **POST** /v6/apple-pay/onboard | Apple Pay Onboarding
*AuthorisationAndPaymentApi* | [**applePayRegistrationGetRequest**](docs/Api/AuthorisationAndPaymentApi.md#applepayregistrationgetrequest) | **GET** /v6/apple-pay/registration | Get Apple Pay Registration
*AuthorisationAndPaymentApi* | [**applePayRegistrationImportRequest**](docs/Api/AuthorisationAndPaymentApi.md#applepayregistrationimportrequest) | **POST** /v6/apple-pay/registration/import | Import Apple Pay Registration
...
*CheckoutContextApi* | [**createCheckoutContext**](docs/Api/CheckoutContextApi.md#createcheckoutcontext) | **POST** /v6/checkout/context/create | Create a Checkout Context
*CheckoutContextApi* | [**exchangeCheckoutContext**](docs/Api/CheckoutContextApi.md#exchangecheckoutcontext) | **POST** /v6/checkout/context/exchange | Exchange a Checkout Context
...
- [ApplePayDomainsRequest](docs/Model/ApplePayDomainsRequest.md)
- [ApplePayOnboardRequest](docs/Model/ApplePayOnboardRequest.md)
- [AttachTokenRequest](docs/Model/AttachTokenRequest.md)
- [AttachTokenResponseModel](docs/Model/AttachTokenResponseModel.md)
...
- [CheckoutContextCapabilities](docs/Model/CheckoutContextCapabilities.md)
- [CheckoutContextCreateRequest](docs/Model/CheckoutContextCreateRequest.md)
- [CheckoutContextExchangeRequest](docs/Model/CheckoutContextExchangeRequest.md)
- [CheckoutContextReference](docs/Model/CheckoutContextReference.md)
...
- [PaymentIntentServices](docs/Model/PaymentIntentServices.md)
