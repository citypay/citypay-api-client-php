...
```php
attachTokenRequest($attach_token_request): \CityPay\Model\AttachTokenResponseModel
```
...
[**\CityPay\Model\AttachTokenResponseModel**](../Model/AttachTokenResponseModel.md)
